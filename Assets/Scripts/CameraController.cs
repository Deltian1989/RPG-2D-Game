...
public class CameraController : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        transform.position = new Vector3(Mathf.Clamp(transform.position.x, bottomLeftLimit.x + leftOffset, topRightLimit.x- rightOffset), Mathf.Clamp(transform.position.y, bottomLeftLimit.y, topRightLimit.y), transform.position.z);
    }
}
